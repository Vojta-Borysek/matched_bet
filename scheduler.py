...
from all_bettano_links import betano_urls_all


class MainClass:
    def __init__(self):
        # Initialization code for your main class
        pass

    def run(self):
        # Method that will be executed every 10 minutes
        print("Running MainClass!")

        betano_urls = betano_urls_all().get_all_urls()
